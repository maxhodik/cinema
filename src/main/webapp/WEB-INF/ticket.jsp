        ...
        <body>
          <div class="container col-3">
            ...
            <div class="form-group">
              <label for="Login">
                <fmt:message key="label.login" />: ${orderDto.login}
              </label>
              <br>
              <label for="Date">
              ...
              <br>
              <label for="Time">
                <fmt:message key="label.time" />: ${sessionDto.time}
              </label>
              <br>
              <label for="Movie">
                <fmt:message key="label.movie" />: ${sessionDto.movieName}
              </label>
              <br>
              <label for="Number of tickets">
                <fmt:message key="label.seats" />: ${orderDto.numberOfSeats}
              </label>
              <br>
              <label for="Price">
                <fmt:message key="label.price" />: ${orderDto.price}
              </label>
              <br>
              <label for="Count">
                <fmt:message key="label.count" />: ${orderDto.count}
              </label>
              <br>
