                ...
                <body>
                    <c:if test="${sessionScope.exception == true}">
                        <label class="alert alert-info">
                            <fmt:message key="alert.movie.already.busy" />
                        </label>
                    </c:if>
                    ...
                    <form action="movie">
                        <li class="nav-item">
                            <a class="btn btn-outline-secondary " aria-current="page"
                                href="${pageContext.request.contextPath}/admin/movie/add-movie">
                                <fmt:message key="button.new_movie" />
                            </a>
                            <class="item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <thead>
                                        ...
                                        <li><a class="dropdown-item" href="${base.concat(orderById).concat(limits)}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-outline-dark" type="submit"
                                                        href="${pageContext.request.contextPath}/admin/movie/update-movie?id=${movieDto.id}">
                    ...
                    <c:choose>
                        <c:when test="${not empty orderBy}">
                            <c:set var="href" scope="request" value="movie?orderBy=${orderBy}&" />
                        </c:when>
                        <c:otherwise>
                            <c:set var="href" scope="request" value="movie?" />
                        </c:otherwise>
                    </c:choose>
